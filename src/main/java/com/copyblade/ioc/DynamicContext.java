...
import com.copyblade.ioc.reader.ClassPathClassReader;
import com.copyblade.ioc.reader.JarReaderImpl;
...
public final class DynamicContext {
    ...
    public static Stream<ClassInfo> recursionFindClasses(String packageName) {
        Scanner        scanner    = Scanner.builder().pageName(packageName).recursive(true).build();
